  ...
  <main class="flex px-3 sm:px-0 mb-8">
    <ul class="w-full md:w-4/5 lg:w-3/6 mx-4 md:mx-auto">
      <li class="mb-4 relative dark:hover:fill-white" v-for="link in links">
        ...
        <div class="absolute right-0 top-0 h-full w-24 flex items-center justify-center z-0 hover:z-20">
          <button type="button" class="p-3 rounded-full hover:bg-gray-50 dark:hover:fill-black" @click="$emit('showShareModal', link.url)">
