                    ...
                    <div className="md:w-4/6 mx-auto">
                        <ul className="py-6 flex justify-center">
                            <li className="mr-3 inline">
                                <a className="text-green-400  hover:text-green-600"
                            ...
                            <li className="mr-3 inline">
                                ...
                                >
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                         className="dark:fill-white">
                                        <path
                                            d="M17 2H7c-1.103 0-2 .897-2 2v16c0 1.103.897 2 2 2h10c1.103 0 2-.897 2-2V4c0-1.103-.897-2-2-2zM7 16.999V5h10l.002 11.999H7z"></path>
                                    </svg>
                                </a>
                            </li>
                            <li className="mr-3 inline">
